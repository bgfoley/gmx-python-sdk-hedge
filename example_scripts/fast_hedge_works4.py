...
def main():
    ...
    callback_gas_limit_wei = callback_gas_limit
    collateral_delta_eth = deposit_eth - execution_fee_eth - (callback_gas_limit_wei / 1e18)
    ...
    order_params = [
        ...
        [
            ...
            str(execution_fee_wei),  # Ensure execution fee is formatted correctly
            str(callback_gas_limit_wei),
            '0'
        ],
        order_type,
